...
export default function Navbar(){
    ...
    return(
        <div className=" fixed top-0 w-full  h-[60px]  shadow-4xl bg-gradient-to-r from-purple-800 to-purple-900 flex justify-between">
            ...
            <div className="flex">
            <div className="text-white text-xl p-4 pr-[30px] hover:bg-purple-800  cursor-pointer" onClick={()=>{router.push("/contactus")}}>
                Contact us
            </div>
            <div className="text-white text-xl p-4 pr-[30px] hover:bg-purple-800  cursor-pointer" onClick={()=>{router.push("/aboutus")}}>
                About Us
            </div>
            <div className="text-white text-xl mr-[60px] rounded-4xl p-4  hover:bg-purple-800  cursor-pointer">
                Me
            </div>
            </div>
